...
export const Footer = () => {
  return (
    <footer className="w-full bg-gray-50">
      <section className="max-w-1200 mx-auto px-4 pb-7 pt-10">
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col items-center justify-between gap-6 border-b-2 border-gray-200 pb-10 lg:flex-row">
            ...
            <div className="flex flex-col items-center gap-6 lg:flex-row lg:gap-12">
              ...
              <button className="flex items-center gap-2 rounded-xl bg-sky-50 py-3 pl-5 pr-7 text-base font-semibold text-sky-700 shadow-sm shadow-transparent transition-all duration-500 focus-within:bg-violet-200 focus-within:outline-0 hover:bg-sky-200">
                <svg
